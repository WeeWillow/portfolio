...
<template>
<section>
    <h2>Hvad Jeg Arbejder Med</h2>
    <div class="content">
      <div class="box">
        <p>Som 2. års studerende er jeg i fuld gang med at udvikle mine færdigheder inden for UX/UI design og frontend udvikling. Jeg har stiftet bekendtskab med værktøjer som Vue.js, WordPress, Figma og Adobe XD, og jeg arbejder konstant på at udvide min viden.</p>
        <RouterLink to="/about" class="btn">Læs mere om mig</RouterLink>
      </div>
      <div class="icons">
        <div class="icon">
